  ...
  <div style="min-height: 100vh">
    <div class="container jobs-container">
      ...
      <div class="all-jobs">
        <div v-for="item in store.careers" class="job">
          <h4>{{ item.title }}</h4>
          <div
            class="d-flex align-items-center flex-column flex-xl-row flex-lg-row w-100 justify-content-between"
          >
            <p>
    ...
    <div v-if="actJob" class="popup-container">
      ...
      <div class="modal-form">
        <div
          class="d-flex align-items-center justify-content-between w-100 header-form"
        >
          <div class="apply-div">
            <span> {{ $t("applyTo") }} </span>
          </div>
        ...
        <div class="inputs">
          ...
          <div class="input-custom">
            ...
            <div class="label-container">
              ...
              <input type="tel" name="phone" maxlength="10" v-model="phone" v-bind="phoneAttrs" :placeholder="$t('phone')" />
            </div>
