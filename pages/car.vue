  ...
  <div style="min-height: 100vh">
    <div v-if="mainCar" class="container">
      <div class="product-page">
        <div class="row">
          <div class="col-12 order-2 order-xl-1 order-lg-1 col-xl-4 col-lg-4">
            <div class="details-container">
              <div class="comp-price">
                <span v-if="mainCar?.other_text_ar"> {{ locale == 'ar' ? mainCar?.other_text_ar : mainCar?.other_text_en
                  }} </span>
              ...
              <div class="colors-container">
                ...
                <div class="d-flex flex-column gap-4 main-colors">
                  ...
                  <div class="colors">
                    <div v-for="(color, index) in mainCar.color" :key="index" class="color"
                      :style="{ backgroundColor: color.hex_code }" @click="activeColor = index + 1" :class="{
              ...
              <div class="btns-container">
                ...
                <div class="icons">
                  <div @click="
                    ...
                    " class="icon">
                    <svg v-if="mainCar.is_fav" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                  ...
                  <div class="icon" @click="shareIcons = !shareIcons">
                    <svg v-if="!shareIcons" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                      viewBox="0 0 24 24" fill="none">
                    ...
                    <svg v-else xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 17 16"
                      fill="none">
                      <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <div v-if="shareIcons" class="share-box">
                      ...
                      <button @click="copyToClipboard2()">
                        <img v-if="checkCopy" src="~/assets/imgs/social5.svg" alt="" />
              ...
              <div class="change-btns">
                <button :class="{ active: activeBtn == 1 }" @click="activeBtn = 1">
                  {{ $t("abilites") }}
                </button>
                <button :class="{ active: activeBtn == 2 }" @click="activeBtn = 2">
                  {{ $t("features") }}
                </button>
              </div>
          ...
          <div class="col-12 order-1 order-xl-2 order-lg-2 col-xl-8 col-lg-8 bg-dange">
            <swiper :spaceBetween="30" :pagination="{ clickable: true }" :modules="[SwiperPagination, SwiperAutoplay]"
              class="mySwiper">
              <swiper-slide v-for="i in mainCar.images">
                <a :data-src="i" href="javascript:;" data-fancybox="gallery" data-caption="Gallery A #1">
                  <img :src="i" alt="car" />
                </a>
              </swiper-slide>
            </swiper>
