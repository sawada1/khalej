        ...
        <div  class="container single-new-container">
            ...
            <div class="text-page">
                <div class="breadline">
                    ...
                    <span class="fw-bold"> الخبر </span>

                </div>
                <div>
                    <h1 class="title">
                        سيارة كيا K4 2025 الجديدة
                    </h1>
                    <svg xmlns="http://www.w3.org/2000/svg" width="150" height="3" viewBox="0 0 50 3" fill="none">
  <rect x="11.9048" width="78.0952" height="3.00022" rx="1.50011" fill="#2D9596"/>
  <rect opacity="0.9" width="5.14286" height="3.00022" rx="1.50011" fill="#2D9596"/>
</svg>
                </div>
            </div>
                ...
                <div class="row justify-content-center justify-content-xl-between justify-content-lg-between">
                    <div class="col-12 col-xl-7 col-lg-7">
                        <div  class="img-box">
                            ...
                            <div class="text">
                              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sit quidem perspiciatis voluptatem, labore libero iusto optio, minima exercitationem ullam at repellendus nesciunt quia id enim quam voluptate error veritatis amet.
                              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sit quidem perspiciatis voluptatem, labore libero iusto optio, minima exercitationem ullam at repellendus nesciunt quia id enim quam voluptate error veritatis amet.
                              perspiciatis voluptatem, labore libero iusto optio, minima exercitationem ullam at repellendus nesciunt quia id enim quam voluptate error veritatis amet.
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="news-related">
                            ...
                            <div class="news-box">
                                ...
                                <div class="icons">
                                 ...
                                 <a  :href="`https://www.instagram.com/?url=${routee}`" target="_blank" class="iconn">
                                  <img src="~/assets/imgs/share2.svg" alt="">
                                 </a>
                                 <a  :href="`https://www.facebook.com/sharer/sharer.php?${routee}`" target="_blank" class="iconn">
                                  <img src="~/assets/imgs/share3.svg" alt="">
                                 </a>
                                 <a  :href="`https://www.snapchat.com/share?url=${routee}`" target="_blank" class="iconn">
                                  <img src="~/assets/imgs/share4.svg" alt="">
                                 </a>
                                 <a  :href="`https://twitter.com/intent/tweet?url=${routee}`" target="_blank" class="iconn">
                                  <img src="~/assets/imgs/share5.svg" alt="">
                                 </a>
                                 <a  :href="`https://wa.me/?text=${routee}/`" target="_blank" class="iconn">
