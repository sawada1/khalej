                            ...
                            <div class="news-box">
                                ...
                                <div class="icons">
                                    <button @click="copyToClipboard()" class="iconn">
                                        ...
                                        <svg v-else xmlns="http://www.w3.org/2000/svg" fill="#90a3bf" height="20"
                                    ...
                                    <a :href="`https://www.facebook.com/sharer/sharer.php?${routee}`" target="_blank"
                                        class="iconn">
                                        <img src="~/assets/imgs/share3.svg" alt="facebook" />
                                    </a>
                                    <a :href="`https://www.snapchat.com/share?url=${routee}`" target="_blank"
                                        class="iconn">
                                        <img src="~/assets/imgs/share4.svg" alt="snapchat" />
                                    </a>
                                    <a :href="`https://twitter.com/intent/tweet?url=${routee}`" target="_blank"
                                        class="iconn">
