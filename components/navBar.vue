<template>
  <div>
    <!-- :class="{
        ...
        mobile: toggleNav,
        back:
          route.name !=`${locale == 'ar' ? 'index___ar___default' : 'index___en'}`,
      }" -->
    <nav class="navbar navbar-expand-xl active" :class="{ 'fixed': activeNav  , 'scroll': scrollNav}">
        ...
        <div class="logo navbar-brand ">
          <nuxt-link :to="localePath('/')">
            <div class="logo-container nav-link">
              <div v-if="locale == 'ar'">
                <img class="dark-img" width="202" height="46" src="~/assets/imgs/whiteLogo-rtl.svg" alt="khalej" />
                <img class="white-img" width="202" height="46" src="~/assets/imgs/mainLogo-rtl.svg" alt="khalej" />
              </div>
              <div v-if="locale == 'en'">
                <img class="dark-img" width="202" height="46" src="~/assets/imgs/whiteLogo-ltr.svg" alt="khalej" />
                <img class="white-img" width="202" height="46" src="~/assets/imgs/mainLogo-ltr.svg" alt="khalej" />
              </div>
            </div>
          </nuxt-link>
        </div>
        <button @click="mobileNav()" class="navbar-toggler collapsed" type="button" data-bs-toggle="collapse"
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <div
            ...
            <div @click="overlay = !overlay" class="icon d-none d-xl-flex d-lg-flex">
              ...
              <svg class="dark-img" xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25"
                fill="none">
                <path fill-rule="evenodd" clip-rule="evenodd"
                  d="M17.0252 16.1671L19.4689 18.6344C20.1478 19.3198 19.1297 20.3484 18.4508 19.6629L16.0069 17.1954C13.0712 19.6407 8.74031 19.4538 6.01897 16.7054C3.11347 13.771 3.11347 9.01339 6.01897 6.07898C8.92447 3.14457 13.6352 3.14457 16.5407 6.07898C19.2623 8.82767 19.4471 13.2022 17.0252 16.1671ZM15.5225 7.10735C13.1793 4.74089 9.38035 4.74089 7.0372 7.10735C4.69406 9.47381 4.69406 13.3106 7.0372 15.6771C9.38035 18.0435 13.1793 18.0435 15.5225 15.6771C17.8656 13.3106 17.8656 9.47381 15.5225 7.10735Z"
                  fill="white" />
            ...
            <div v-if="overlay" class="searchBar">
              <div class="inp">
                ...
                <div v-if="dropdown1" :id="dropdown1.id" class="dropdown-container search" @click="dropdown1.toggle()">
                  ...
                  <div v-if="dropdown1.isOpen" class="dropdown-menu" @click.stop>
                    ...
                    <div v-if="dropdown1.items" class="dropdown-item" v-for="item in dropdown1.items" @click.prevent="
                        dropdown1.select2(item), store.getCarsByBrand2(item.id) , (selectedBrand = item.id)
                      " :key="item.id" :for="`checkBox-${item.id}`">
                      <span>
                        {{ item.name }}
                      </span>
                    </div>
              ...
              <div class="inp">
                ...
                <div v-if="dropdown2" :id="dropdown2.id" class="dropdown-container search" @click="dropdown2.toggle()">
                  <button class="dropdown-toggle-container">
                    {{
                  ...
                  <div v-if="dropdown2.isOpen" class="dropdown-menu" @click.stop>
                    <!-- @click.prevent="dropdown1.select(item.title)" -->
                    <div class="dropdown-item" v-for="item in dropdown2.items" @click.prevent="
              ...
              <div class="inp">
                ...
                <div v-if="dropdown3" :id="dropdown3.id" class="dropdown-container search" @click="dropdown3.toggle()">
                  <button class="dropdown-toggle-container">
                    {{
                  ...
                  <div v-if="dropdown3.isOpen" class="dropdown-menu" @click.stop>
                    <!-- @click.prevent="dropdown1.select(item.title)" -->
                    <div class="dropdown-item" v-for="item in dropdown3.items" @click.prevent="
              ...
              <nuxt-link class="searchBtn mt-2" @click="overlay = false , store2.filteredCar = [] , store2.page = 1"
                :to="
                  localePath({
                    path: '/cars',
                    query: {
            ...
            <nuxt-link :to="localePath('/wishlist')" class="nav-link icon">
              ...
              <svg class="white-img" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                ...
                <path
                  ...
                  stroke="#A7B9D0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
            </nuxt-link>
            <a aria-label="phone" :href="'tel:' + store.websiteData?.phone"
              class="nav-link icon d-flex align-items-center gap-3" style="white-space: nowrap">
              <span> {{ store.websiteData?.phone }} </span>
              <svg class="white-img" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                fill="none">
                <path
              ...
              <svg class="dark-img" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                fill="none">
                <path
